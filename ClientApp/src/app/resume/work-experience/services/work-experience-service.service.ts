...
export class WorkExperienceService {
  ...
  getWorkPositions() {
    return this.httpClient.get<WorkExperience[]>('https://localhost:5001/api/workpositions')
  }

  getWorkExperiences() {
    return this.httpClient.get<WorkPosition[]>('https://localhost:5001/api/workexperiences')
  }
